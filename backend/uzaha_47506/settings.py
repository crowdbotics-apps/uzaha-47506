"""
Django settings for uzaha_47506 project.
...
WSGI_APPLICATION = 'uzaha_47506.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "uzaha_47506 API",
    "DESCRIPTION": "API documentation for uzaha_47506 App",
    "VERSION": "v1",
}
